...
class ServicioTecnicoController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        return view('tecnico.servicios.index', [
            'servicios' => $servicios,
            'filtros'   => [
                'buscar'    => $buscar,
                'orden_id'  => $ordenId,
    ...
    public function detalles($id = null)
    {
        ...
        return view('tecnico.servicios.detalles', [
            'orden'                 => $orden,
    ...
    {
        return view('tecnico.servicios.proyecto');
    }
    ...
    public function detallesProyecto($id)
    {
        ...
        return view('tecnico.servicios.proyecto-detalles', [
            'orden'              => $orden,
            'colFechaProgramada' => $colFechaProgramada,
            'colFechaOrden'      => $colFechaOrden,
        ]);
