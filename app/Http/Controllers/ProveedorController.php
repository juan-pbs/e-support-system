...
class ProveedorController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        return view('vistas-gerente.proveedor-gerente.proveedor_gerente', compact('proveedores'));
    }
    ...
    public function crear(Request $request)
    {
        ...
        return view('vistas-gerente.proveedor-gerente.entrada_proveedor_gerente');
    }
    ...
    public function editar($id)
    {
        ...
        return view('vistas-gerente.proveedor-gerente.editar_proveedor_gerente', compact('proveedor'));
    }
