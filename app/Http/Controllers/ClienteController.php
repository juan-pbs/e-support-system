...
class ClienteController extends Controller
{
    public function index(Request $request)
    {
        ...
        return view('vistas-gerente.clientes-gerente.clientes_gerente', [
            'clientes'     => $clientes,
    ...
    public function crear(Request $request)
    {
        ...
        return view('vistas-gerente.clientes-gerente.entrada_cliente_cotizacion_gerente', [
    ...
    public function edit($id)
    {
        ...
        return view('vistas-gerente.clientes-gerente.editar_cliente_gerente', compact('cliente'));
    }
