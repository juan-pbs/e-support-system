...
class EmpleadoController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        return view('vistas-gerente.empleados-gerente.empleados_gerente', compact('empleados', 'busqueda'));
    }

    /** ===== Formulario de alta ===== */
    public function create()
    {
        return view('vistas-gerente.empleados-gerente.entrada_empleado_gerente');
    }
    ...
    public function edit($id)
    {
        ...
        return view('vistas-gerente.empleados-gerente.editar_empleado_gerente', compact('empleado'));
    }
