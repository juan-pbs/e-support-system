            ...
            <div class="xl:col-span-2 bg-white rounded-3xl shadow-sm border border-slate-200 overflow-hidden">
                <div class="px-6 py-5 border-b border-slate-200 bg-gradient-to-r from-slate-900 to-slate-700 text-white">
                    ...
                    <p class="text-sm text-slate-200 mt-1">
                        Usa la plantilla recomendada para evitar errores de encabezados.
                    </p>
                </div>
                    ...
                    <form method="POST" action="{{ route('catalogo.carga_rapida.preview') }}" enctype="multipart/form-data" class="space-y-5">
                        ...
                        <div>
                            ...
                            <input
                                ...
                                name="archivo"
                                accept=".xlsx,.csv,.txt"
                                class="block w-full rounded-2xl border border-slate-300 px-4 py-3 text-sm shadow-sm focus:border-blue-500 focus:ring focus:ring-blue-200"
                                required
                            >
            ...
            <div class="bg-white rounded-3xl shadow-sm border border-slate-200 overflow-hidden">
                ...
                <div class="p-6 space-y-4 text-sm">
                    <div class="flex items-center gap-2">
                        <span class="inline-flex rounded-full bg-red-100 text-red-700 px-3 py-1 font-semibold">Obligatorio</span>
                    ...
                    <div class="flex flex-wrap gap-2">
                        ...
                        <span class="text-slate-600">numero_parte</span>
                        <span class="text-slate-600">categoria</span>
                        <span class="text-slate-600">clave_prodserv</span>
                        <span class="text-slate-600">unidad</span>
                        <span class="text-slate-600">stock_seguridad</span>
                        <span class="text-slate-600">descripcion</span>
                        <span class="text-slate-600">require_serie</span>
                    ...
                    <div class="rounded-2xl bg-slate-50 border border-slate-200 p-4">
                        ...
                        <ul class="space-y-1 text-slate-600">
                            ...
                            <li>• Hoja <strong>Instrucciones</strong> con qué es obligatorio y qué puede ir en blanco.</li>
        ...
        @if ($preview)
            <div class="grid grid-cols-1 md:grid-cols-4 gap-4">
                ...
                <div class="bg-amber-50 rounded-2xl border border-amber-200 shadow-sm p-5">
                    ...
                    <p class="text-3xl font-bold text-amber-800">{{ $stats['duplicados'] ?? 0 }}</p>
                </div>
...
<script>
    setTimeout(() => {
        document.querySelectorAll('.rounded-2xl.border').forEach(el => {
            if (el.innerText.includes('Procesados') || el.innerText.includes('No se pudo') || el.innerText.includes('Corrige')) {
                return;
            }
        });
    }, 5000);
