              ...
              class="bg-white border border-gray-200 shadow-xl rounded-xl p-6 space-y-5" autocomplete="off">
                ...
                {{-- Número de parte (opcional; se autogenera si no se captura) --}}
                    <div>
                        ...
                        <p class="text-xs text-gray-500 mt-1">
                            ...
                            Puedes usar letras, números y símbolos comunes del número de parte.
                        </p>
                    </div>
                ...
                {{-- Categoría --}}
                    <div>
                        ...
                        <p class="text-xs text-gray-500 mt-1">
                            El desglose se conserva. Si necesitas ajustar categorías sin salir de esta vista, hazlo desde el botón de administración.
                        </p>
                        <input type="text" name="categoria_nueva"
                               value="{{ old('categoria_nueva') }}"
                               placeholder="Si no está en la lista, escribe una nueva categoría"
                               class="mt-2 w-full border px-3 py-2 rounded-lg @error('categoria_nueva') border-red-500 @enderror">
                        <p class="text-xs text-gray-500 mt-1">
                            Si capturas una nueva categoría aquí, se guardará y quedará disponible para los demás productos.
                        </p>
            ...
            <div class="w-full max-w-5xl rounded-2xl bg-white shadow-2xl" @click.away="openCategorias = false">
                <div class="flex items-center justify-between border-b border-gray-100 px-6 py-4">
                    <div>
                        ...
                        <p class="text-sm text-gray-500">Ajusta el catálogo sin perder el contexto del alta de producto.</p>
                    </div>
