      ...
      <div class="bg-white rounded-2xl shadow-sm border border-slate-200 overflow-hidden fade-in flex flex-col">
        ...
        >
          ...
          <div>
            ...
            >
              @include('gerencia.reportes.tipos.ventas')
              @include('gerencia.reportes.tipos.tecnicos_top')
              @include('gerencia.reportes.tipos.entradas')
              @include('gerencia.reportes.tipos.salidas')
              @include('gerencia.reportes.tipos.stock_critico')
              @include('gerencia.reportes.tipos.clientes_top')
              @include('gerencia.reportes.tipos.cotizaciones_estado')
            </div>
          </div>
    ...
    <div class="flex flex-col">
      <div class="bg-white rounded-2xl shadow-sm border border-slate-200 overflow-hidden fade-in flex flex-col">
        ...
        >
          ...
          @include('gerencia.reportes.preview.salidas')
          @include('gerencia.reportes.preview.stock_critico')
          @include('gerencia.reportes.preview.clientes_top')
          @include('gerencia.reportes.preview.cotizaciones_estado')
