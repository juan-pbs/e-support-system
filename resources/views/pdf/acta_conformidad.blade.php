...
<head>
  ...
  <style>
    ...
    .tabla-totales th { text-align:left; font-weight:normal; }
    ...
    .sign-area { margin: 0 30px; text-align: center; }
        ...
        <tbody>
          @foreach($extras as $e)
            @php
              ...
              $desc  = $e->concepto ?? $e->descripcion ?? 'Gasto extra';
            ...
            <tr>
              ...
              <td style="white-space: pre-line;">
                {{ $desc }}
                @if($pendiente)
                  <span class="muted"> (pendiente de precio)</span>
                @endif
              </td>
              <td class="text-right">
                @if($pendiente)
      ...
      <div class="section">
        ...
        <div class="totales-panel" style="margin-top:6px;">
          <table class="tabla-totales small">
            ...
            @if($monedaOrden === 'USD')
              <tr>
                <td colspan="2" style="text-align:left; padding-top:6px;" class="small muted">
